// Initialize Supabase
const SUPABASE_URL = 'https://hkjwhbezlujqlwqmkrlh.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhrandoYmV6bHVqcWx3cW1rcmxoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE0NDY0NDUsImV4cCI6MjA3NzAyMjQ0NX0.mgsQ_cTo_mVvlYS9zIrtNAQ1En6tLgLAMIBJmK0xSOg';
...
const OPENROUTER_API_KEY = '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';
const MODELS = [
...
function updateModuleCards() {
    ...
    moduleCards.forEach(card => {
        ...
        if (userProgress.completedModules && userProgress.completedModules.includes(moduleNum)) {
            // Module is completed - grey it out and change button text
            card.classList.add('completed');
            card.classList.remove('locked');
            if (startButton) {
                startButton.textContent = 'Restart Module';
                startButton.innerHTML = '<i class="fas fa-redo"></i> Restart Module';
